...
> 
> ```bash
> # Splunk - Detect Notepad++ Anomalous Network Activity [truncated]
> ```
...
> 
> ```bash
> # Splunk - Detect Ransomware Indicators (VSS Deletion + Backup Destruction) [truncated]
> ```
...
> 
> ```bash
> # Splunk - Detect Active Scanning (T1595) [truncated]
> ```
