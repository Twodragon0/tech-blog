...
- **주요 모니터링 대상**: 중국 연계 TA416, PlugX 및 OAuth 기반 피싱으로 유럽 정부 표적, Axios Maintainer를 대상으로 한 UNC1069의 사회공학적 공격으로 npm 공급망 공격 발생, 고객의 보안 태세에서 가장 큰 격차는 바로 제3자 리스크입니다 등 High 등급 위협 6건에 대한 탐지 강화가 필요합니다.
