...
excerpt: "Microsoft Defender 제로데이 취약점 3건 악용 중 · 구성 기반 ETL 솔루션으로 보안 로그를 OCSF 형식으로 변환하기 등 2026년 04월 18일 보고된 27건의 보안/기술 이슈를 운영 관점에서 점검합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
