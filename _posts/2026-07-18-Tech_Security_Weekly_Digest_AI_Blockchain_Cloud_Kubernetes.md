...
| 제목 | 출처 | 핵심 내용 |
|------|------|----------|
| [먼 별의 생명체 거주 가능 영역에 있는 지구형 행성에서 최초로 대기 발견](https://news.hada.io/topic?id=31539) | GeekNews (긱뉴스) | 지구에서 48광년 떨어진 암석 행성 LHS 1140 b 에서 대기가 확인돼, 태양계 밖 생명체 거주 가능 영역의 지구형 행성으로는 첫 사례가 됨 지금까지 검출된 기체는 상층 대기에 있을 것으로 추정되는 헬륨 뿐이지만, 더 낮은 대기층에 다른 기체가 존재할 |
...
| Netflix Tech Blog | [netflixtechblog.com](https://netflixtechblog.com) | 본문 1건 인용 |
