...
excerpt: "2026년 06월 06일 공개된 25건의 위협·취약점 가운데 IronWorm과 새로운 Miasma Worm 변종이 공급망 · Android 스파이웨어 Asin, 가짜 뉴스·PDF가 즉각 대응 우선순위에 올랐습니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
...
| Hugging Face Blog | [huggingface.co](https://huggingface.co) | 본문 1건 인용 |
