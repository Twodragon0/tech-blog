...
| 영역 | 현재 위험도 | 즉시 조치 |
|------|-------------|-----------|
| 가시성/탐지 | High | SIEM 연계 로그 커버리지 점검, 탐지 사각지대 축소 |
| 규제/컴플라이언스 | Medium | 암호화폐·광고 정책 변경 반영, 내부 가이드 재배포 |
| AI 에이전트 활용 | Medium | MCP/도구 사용 정책 명확화, 권한 분리 적용 |
...
- [기술·보안 주간 다이제스트 (3월 1일)]({% post_url 2026-03-01-Tech_Security_Weekly_Digest_AI_Agent_Ransomware %}) - AI 에이전트 보안, 랜섬웨어 위협
- [기술·보안 주간 다이제스트 (3월 4일)]({% post_url 2026-03-04-Tech_Security_Weekly_Digest_AI_Ransomware_Bitcoin %}) - AI 랜섬웨어, Bitcoin 보안
...
| Claude Code 문서 | [docs.anthropic.com/en/docs/claude-code/overview](https://docs.anthropic.com/en/docs/claude-code/overview) | Claude Code CLI 공식 가이드 |
