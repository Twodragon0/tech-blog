...
description: "클라우드 시큐리티 8기 1주차 핵심 정리. 클라우드 인프라의 본질적 이해부터 2025년 최신 보안 트렌드까지 폭넓게 다룹니다. AI 보안 위협 대응 전략, Zero Trust 아키텍처 설계 원칙, Post-quantum 암호화 등 미래 보안 기술을 실무 중심으로 학습합니다."
...
| where requestParameters.AccessControlList.Grant{}.Grantee.URI="[링크](http://acs.amazonaws.com/groups/global/AllUsers)"
...
- [8기 오리엔테이션: DevSecOps부터 FinOps까지]({% post_url 2025-11-21-Cloud_Security_8Batch_OT_Guide_DevSecOpsFrom_FinOpsTo_Practical_Talent_Leap %})
