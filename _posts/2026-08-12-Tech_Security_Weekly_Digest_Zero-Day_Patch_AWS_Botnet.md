...
excerpt: "마이크로소프트, 활성 공격 중인 Windows 드라이버 제로데이 · Kimwolf v7 Android 봇넷 등 2026년 08월 12일 보고된 29건의 보안/기술 이슈를 운영 관점에서 점검합니다. 각 항목의 원문 링크를 함께 실어 1차 출처에서 바로 확인할 수 있습니다."
