...
excerpt: "마이크로소프트, 활성 공격 중인 Windows 드라이버 제로데이 · Kimwolf v7 Android 봇넷 등 2026년 08월 12일 보고된 29건의 보안/기술 이슈를 운영 관점에서 점검합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
