...
excerpt: "2026년 08월 03일 수집한 15건의 보안 이슈 중 OpenAI, 10개의 오랜 난제를 해결한 후 차기 주요 AI 모델 · COLDCARD 지갑 RNG 결함, 8800만 달러 규모 비트코인을 중심으로 영향 범위와 패치 우선순위를 분석합니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
