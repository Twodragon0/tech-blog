...
excerpt: "2026년 06월 10일 수집한 30건의 보안 이슈 중 Meta, 오프사이트 비즈니스 데이터를 피드 및 AI 개인화에 활용 · Veeam Backup & Replication RCE 취약점으로를 중심으로 영향 범위와 패치 우선순위를 분석합니다. 각 항목의 원문 링크를 함께 실어 1차 출처에서 바로 확인할 수 있습니다."
