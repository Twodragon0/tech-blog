...
│   └─────────────────────────────────────────────────────────┘  │
│                                                                 │
│   규제 준수: GDPR | NIS2 | DORA | eIDAS 2.0                    │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
│                                                                 │
│   EC2 G7e (AI 추론)                                             │
│   ├─> Spot 인스턴스 활용: 최대 90% 절감                         │
│   ├─> 자동 스케일링: 트래픽 기반 스케일링                       │
│   └─> 예약 인스턴스: 안정적 워크로드용                          │
│                                                                 │
│   EC2 X8i (메모리 집약적)                                       │
│   ├─> Savings Plans: 1년/3년 약정 할인                          │
│   ├─> 적정 사이징: 실제 메모리 사용량 분석                      │
│   └─> 예약 용량: SAP HANA 등 미션 크리티컬                      │
│                                                                 │
│   GCP Bangkok Region                                            │
│   ├─> Committed Use Discounts: 최대 57% 할인                    │
│   ├─> Preemptible VMs: 개발/테스트 환경                         │
│   └─> 멀티리전 비용 비교: Singapore vs Bangkok                  │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
