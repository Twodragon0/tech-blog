...
excerpt: "2026년 02월 12일 보안 뉴스: The Hacker News · 실무 관점에서 영향 범위와 우선순위를 함께 점검해야 합니다가 부각된 2026년 02월 12일 보안 다이제스트 — 27건의 이슈와 실행 가능한 대응 액션을 정리합니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
...
| 리소스 | 링크 | 용도 |
|--------|------|------|
| CISA KEV Catalog | [cisa.gov/known-exploited-vulnerabilities-catalog](https://www.cisa.gov/known-exploited-vulnerabilities-catalog) | 실제 악용 확인된 취약점 목록 — 패치 우선순위 기준 |
...
- [2026년 02월 13일 주간 보안 다이제스트: 악성코드·BYOVD EDR·북한 위협 (3건)](/posts/2026/02/13/Tech_Security_Weekly_Digest_AI_Go_Security_Agent/) — 2026-02-13
