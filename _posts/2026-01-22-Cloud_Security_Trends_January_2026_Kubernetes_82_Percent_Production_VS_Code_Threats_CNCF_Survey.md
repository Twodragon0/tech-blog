...
excerpt: "2026년 1월 클라우드 보안 핵심 동향 분석. CNCF 연례 조사에서 Kubernetes 프로덕션 사용률 82% 달성, VS Code 악용 위협 확대, CRI-O 보안 감사 완료, Net-NTLMv1 레인보우 테이블 공개 등 주요 보안 이슈와 대응 방안 정리."
comments: true
...
│                                                                 │
│   Phase 2: NTLMv2로 전환                                        │
│   └─> LmCompatibilityLevel = 3 이상 설정                        │
│   └─> 호환성 테스트 수행                                        │
│                                                                 │
│   Phase 3: Kerberos 우선 정책                                   │
│   └─> SPN 구성 검토, Kerberos 인증 활성화                       │
│                                                                 │
│   Phase 4: NTLM 제한/비활성화                                   │
│   └─> 그룹 정책을 통한 NTLM 제한                                │
│   └─> 예외 목록 관리                                            │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
