...
excerpt: "악성 KICS Docker 이미지와 VS Code 확장이 · 자체 전파 공급망 웜이 npm 패키지를 탈취해 개발자 토큰을 훔치다가 부각된 2026년 04월 23일 보안 다이제스트 — 30건의 이슈와 실행 가능한 대응 액션을 정리합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
