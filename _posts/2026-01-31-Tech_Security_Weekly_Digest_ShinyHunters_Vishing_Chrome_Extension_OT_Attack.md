...
excerpt: "Mandiant 발표 - SaaS 플랫폼 대상 비싱 공격으로 MFA · 악성 확장이 어필리에이트 링크 하이재킹 및 ChatGPT 인증 토큰이 부각된 2026년 01월 31일 보안 다이제스트 — 15건의 이슈와 실행 가능한 대응 액션을 정리합니다. 각 항목의 원문 링크를 함께 실어 1차 출처에서 바로 확인할 수 있습니다."
