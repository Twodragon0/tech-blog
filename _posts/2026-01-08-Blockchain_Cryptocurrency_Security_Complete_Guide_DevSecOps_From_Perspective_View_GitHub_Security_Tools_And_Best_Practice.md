...
{%- include ai-summary-card.html
  title='블록체인 암호화폐 보안 완벽 가이드: DevSecOps 관점에서 본 GitHub 보안 도구 및 모범 사례'
  categories_html='<span class="category-tag blockchain">Blockchain</span>'
  tags_html='<span class="tag">Blockchain</span>
  ...
  highlights_html='<li><strong>스마트 컨트랙트 보안 도구 비교</strong>: Slither(정적 분석, 빠른 초기 검사), Mythril(심볼릭 실행, 깊이 있는 분석), Securify 2.0(패턴+데이터 흐름, 높은 정확도), Medusa 2025(차세대 퍼저, 커버리지 기반)</li>
