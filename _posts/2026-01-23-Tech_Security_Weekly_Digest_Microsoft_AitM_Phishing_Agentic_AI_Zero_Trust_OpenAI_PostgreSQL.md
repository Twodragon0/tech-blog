...
excerpt: "에너지 기업 대상 다단계 AitM 피싱 & BEC 공격 경고 - · Agentic AI 시스템의 Zero Trust NHI(비인간 등 2026년 01월 23일 보고된 15건의 보안/기술 이슈를 운영 관점에서 점검합니다. 보안 운영센터(SOC)와 DevSecOps 팀이 즉시 적용할 수 있는 차단·완화 조치를 요약합니다."
