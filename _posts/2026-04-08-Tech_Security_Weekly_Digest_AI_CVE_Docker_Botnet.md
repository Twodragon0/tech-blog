...
excerpt: "러시아 국가 연계 APT28, 글로벌 DNS 하이재킹 캠페인에서 · [웨비나] AI가 기업 리스크를 악용하기 전에 2026년까지가 부각된 2026년 04월 08일 보안 다이제스트 — 18건의 이슈와 실행 가능한 대응 액션을 정리합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
