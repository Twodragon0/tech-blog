...
{% include ai-summary-card.html
  ...
  tags_html='<span class="tag">Security-Weekly</span>
      ...
      <span class="tag">Lazarus</span>
      <span class="tag">Copilot-Studio</span>
      <span class="tag">Gemini-AI</span>
      <span class="tag">2026</span>'
  highlights_html='<li><strong>Gemini AI 악용 국가 배후 공격</strong>: 북한 UNC2970이 Gemini를 정찰·사회공학·악성코드 개발 가속에 활용 — AI 무기화 실증 사례</li>
      <li><strong>Lazarus npm/PyPI 캠페인</strong>: 위장 채용 미끼로 개발자 공급망 공격 — 2025년 5월부터 장기 은닉</li>
      <li><strong>Copilot Studio Top 10 리스크</strong>: 에이전트 권한 확대에 따른 설정 오류가 치명적 보안 노출로 직결</li>
      <li><strong>FinOps 비용 절감 가이드</strong>: Google Cloud 청구/절감 구조 단순화 및 CUD 업데이트</li>'
