...
summary_card:
  ...
  tags:
    ...
    - "EKS"
  highlights:
    - { source: "", title: "Karpenter v1.5.3 공격적 노드 통합 정책으로 인한 장애 분석" }
    - { source: "", title: "PodDisruptionBudget 미설정으로 20개 이상 Pod 동시 재시작" }
    - { source: "", title: "NodePool 설정 수정 및 PDB 적용을 통한 재발 방지 대책" }
---
