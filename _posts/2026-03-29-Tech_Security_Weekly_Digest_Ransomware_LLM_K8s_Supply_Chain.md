...
excerpt: "랜섬웨어 그룹이 AI 기반 공격 자동화 도구를 활용한 표적형 공격 · LLM 탈옥 취약점 CVE-2026-3291로 주요 모델 안전장치를 비롯한 2026년 03월 29일 보안/기술 동향 15건을 DevSecOps 시선으로 정리합니다. 각 항목의 원문 링크를 함께 실어 1차 출처에서 바로 확인할 수 있습니다."
