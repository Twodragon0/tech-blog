...
excerpt: "Atlassian Rovo가 Jira 및 Confluence · 새로운 CSS 공격으로 웹메일 방어를 우회해 비밀번호와 토큰 탈취를 비롯한 2026년 08월 09일 보안/기술 동향 16건을 DevSecOps 시선으로 정리합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
