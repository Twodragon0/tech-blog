...
- Code-Security
- AWS
keywords: [Amazon-Q, GitHub-Advanced-Security, Code-Security, AWS]
...
description: "Amazon Q Developer와 GitHub Advanced Security를 결합한 코드 보안 강화 가이드. AI 기반 코드 생성과 리뷰, 보안 취약점 자동 탐지, SAST/SCA 통합, DevSecOps 모범 사례, AWS 비용 최적화 제안까지 2025년 최신 트렌드를 정리합니다."
...
<details>
<summary>GitHub Actions CodeQL 분석 워크플로우 (click to expand)</summary>
...
<details>
<summary>Secret Scanning 알림 자동 처리 스크립트 (click to expand)</summary>
...
- [CodeQL Documentation](https://docs.github.com/en/code-security/codeql) - CodeQL 쿼리 언어 문서
...
- [GitHub Security Lab](https://github.com/github/securitylab) - 보안 연구 및 CodeQL 쿼리
