...
![AWS Defense in Depth](/assets/images/mermaid/aws_defense_depth.svg)
...
## MITRE ATT&CK 매핑: AWS/EKS 위협 모델링
...
> **코드 예시**: 네트워크 정책 기본 템플릿은 [Kubernetes NetworkPolicy 문서](https://kubernetes.io/docs/concepts/services-networking/network-policies/)와 [NetworkPolicy Recipes](https://github.com/ahmetb/kubernetes-network-policy-recipes)를 참고하세요.
...
> **코드 예시**: GuardDuty 자동 대응 Lambda 예시는 [AWS GuardDuty Automated Response](https://github.com/aws-samples/amazon-guardduty-automated-response-and-remediation)를 참고하세요.
