...
excerpt: "2억 8500만 달러 규모 Drift 해킹, 신종 피싱 문자에 QR 코드를 활용한 교통위반, New FortiClient EMS 취약점을 중심으로 2026년 04월 06일 주요 보안/기술 뉴스 15건과 대응 우선순위를 정리합니다."
...
| **인증 보안** | 1건 | 해커 익스플로잇 React2Shell automated 자격증명 theft |

이번 주기의 핵심 트렌드는 **AI/ML**(2건)입니다. rtk, Google AI Edge Gallery 등이 주요 이슈입니다. **클라우드 보안** 분야에서는 AWS 엔지니어 관련 동향에 주목할 필요가 있습니다.
