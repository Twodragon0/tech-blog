...
- **긴급 대응 필요**: Vercel 2026년 4월 보안 사고 등 Critical 등급 위협 1건이 확인되었습니다.
- **주요 모니터링 대상**: Apple 계정 변경 알림을 악용한 피싱 이메일 발송, Vercel, 내부 시스템 침해 발생했다고 밝혀 등 High 등급 위협 2건에 대한 탐지 강화가 필요합니다.
