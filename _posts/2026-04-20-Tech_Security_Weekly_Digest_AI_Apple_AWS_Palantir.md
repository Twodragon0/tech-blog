...
excerpt: "Apple 계정 변경 알림을 악용한 피싱 이메일 발송 · NIST, 증가하는 취약점 수로 인해 비우선순위 결함 평가 중단 등 2026년 04월 20일 보고된 14건의 보안/기술 이슈를 운영 관점에서 점검합니다. 실무 체크리스트에 패치 적용 항목을 함께 정리했습니다."
