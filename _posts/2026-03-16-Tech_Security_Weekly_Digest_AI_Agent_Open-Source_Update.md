...
excerpt: "2026년 03월 16일 공개된 15건의 위협·취약점 가운데 Show HN: 악용 코드가 공개된 AI 에이전트를 레드팀할 수 · Amazon Bedrock과 Claude Agent SDK로가 즉각 대응 우선순위에 올랐습니다. 각 항목의 원문 링크를 함께 실어 1차 출처에서 바로 확인할 수 있습니다."
