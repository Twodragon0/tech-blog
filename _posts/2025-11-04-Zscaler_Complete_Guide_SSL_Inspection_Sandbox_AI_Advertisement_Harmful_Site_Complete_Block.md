...
redirect_from:
  ...
  - /posts/2025-11-04-Zscaler_Complete_Guide_SSL_Inspection_Sandbox_AI_Advertisement_Harmful_Site_Complete_Block/
summary_card:
  ...
  tags:
    ...
    - "Cloud-Security"
  highlights:
    - { source: "", title: "하이브리드 근무 환경에서 사용자가 어디서든 기업 리소스에 안전하게 접근" }
    - { source: "", title: "Zscaler의 클라우드 기반 Zero Trust 보안 아키텍처 및 핵심 정책" }
    - { source: "", title: "SSL 검사, 샌드박스(ATP), AI/광고/유해 사이트 차단 실무 설정" }
---
