...
excerpt: "2026년 03월 27일 수집한 15건의 보안 이슈 중 IAM Identity Center + SCP 기반 Zero · Workload Identity Federation 보안 베스트를 중심으로 영향 범위와 패치 우선순위를 분석합니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
