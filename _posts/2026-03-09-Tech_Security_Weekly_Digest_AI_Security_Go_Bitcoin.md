...
{% include news-card.html
  ...
  summary="AI 어시스턴트가 보안 기준을 바꾸고 있다 이슈를 중심으로 공격 벡터와 영향 범위를 점검하고, 탐지·차단·복구 관점의 우선 대응 항목을 실무 기준으로 정리했습니다."
...
{% include news-card.html
  ...
  summary="은행에게 암호화폐 규제 명확성이 더 중요 — 전 CFTC 위원장 이슈를 중심으로 공격 벡터와 영향 범위를 점검하고, 탐지·차단·복구 관점의 우선 대응 항목을 실무 기준으로 정리했습니다."
...
{% include news-card.html
  ...
  summary="Saylor, BTC $66K 근처에서 추가 매수 신호 이슈를 중심으로 공격 벡터와 영향 범위를 점검하고, 탐지·차단·복구 관점의 우선 대응 항목을 실무 기준으로 정리했습니다."
  source="Cointelegraph"
  severity="Medium"
%}
...
{% include news-card.html
  ...
  summary="브라질 Pix 즉시결제 시스템, 아르헨티나로 확장 이슈를 중심으로 공격 벡터와 영향 범위를 점검하고, 탐지·차단·복구 관점의 우선 대응 항목을 실무 기준으로 정리했습니다."
  source="Cointelegraph"
  severity="Medium"
%}
...
{% include news-card.html
  ...
  summary="엔터프라이즈 LLM 서비스 구축기 2: 에이전트 엔지니어링 이슈를 중심으로 공격 벡터와 영향 범위를 점검하고, 탐지·차단·복구 관점의 우선 대응 항목을 실무 기준으로 정리했습니다."
...
{% include news-card.html
  ...
  summary="전쟁은 AI 기업의 윤리 원칙을 어디까지 밀어붙였나? 이슈를 중심으로 공격 벡터와 영향 범위를 점검하고, 탐지·차단·복구 관점의 우선 대응 항목을 실무 기준으로 정리했습니다."
  source="GeekNews"
  severity="Medium"
%}
...
{% include news-card.html
  ...
  summary="Agent Safehouse — macOS용 로컬 에이전트 샌드박싱 도구 이슈를 중심으로 공격 벡터와 영향 범위를 점검하고, 탐지·차단·복구 관점의 우선 대응 항목을 실무 기준으로 정리했습니다."
  source="GeekNews"
  severity="Medium"
%}
