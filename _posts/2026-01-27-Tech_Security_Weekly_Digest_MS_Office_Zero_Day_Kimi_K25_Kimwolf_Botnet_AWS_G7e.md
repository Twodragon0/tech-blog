...
{% include ai-summary-card.html
  title='기술·보안 주간 다이제스트: MS Office Zero-Day 긴급패치, Kimi K2.5 오픈소스 에이전트, Kimwolf 봇넷 위협'
  ...
  highlights_html='<li><strong>포인트 1</strong>: 핵심 주제는 MS Office Zero-Day 실제 악용 입니다</li>       <li><strong>포인트 2</strong>: 실무 관점에서 영향 범위와 우선순위를 함께 검토해야 합니다</li>       <li><strong>포인트 3</strong>: 팀 운영에서는 재현 가능한 적용 절차와 검증 기준을 문서화해야 합니다</li>'
...
Kimi K2.5의 에이전트 아키텍처는 Vision, Code, Tool, Memory 에이전트 및 Tool Registry를 통합한 Orchestrator를 중심으로 구성되어 있습니다.
...
<div class="diagram-container">
Badbox 2.0 Kimwolf Botnet의 감염 경로는 제품 제조와 유통 단계를 거쳐 대상 네트워크 침투 및 측면 이동(Lateral Movement)으로 이어집니다.
...
<div class="diagram-container">
AWS EC2 GPU 인스턴스 성능 비교 결과, G5 Ampere 기준 대비 G7e Blackwell은 2.3배, G6e Ada는 1.5배의 뛰어난 성능을 보였으며 G4 Turing은 0.85배 수준을 기록했습니다.
...
<div class="diagram-container">
보안 제한 사항이 적용된 Python, Node.js, Bash 기반의 ChatGPT 컨테이너 환경 아키텍처를 보여줍니다.
