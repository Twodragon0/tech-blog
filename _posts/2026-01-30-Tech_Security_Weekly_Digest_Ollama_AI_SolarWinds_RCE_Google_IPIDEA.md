...
> 
> ```yaml
> # docker-compose.yml - Ollama 보안 배포 구성 [truncated]
> ```
...
> 
> ```yaml
> # sigma/rules/application/ollama_unauthorized_access.yml [truncated]
> ```
...
> 
> ```yaml
> # SolarWinds WHD 역직렬화 공격 탐지 [truncated]
> ```
...
> 
> ```yaml
> # SolarWinds WHD 긴급 보안 강화 조치 [truncated]
> ```
...
> 
> ```yaml
> # IPIDEA 프록시 네트워크 DNS 차단 정책 [truncated]
> ```
...
> 
> ```yaml
> # /etc/suricata/rules/ot-protocols.rules [truncated]
> ```
