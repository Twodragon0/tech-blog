...
>
> **핵심 내용**: 2025년 9월 8일 npm 레지스트리의 18개 핵심 패키지(debug, chalk, lodash, axios, express 등)가 악성코드에 감염되었습니다. postinstall 스크립트를 통한 환경변수 수집, C2 서버 통신, 백도어 설치 등의 공격 체인과 IOC(Indicators of Compromise), 영향 확인 스크립트, 긴급 복구 절차, 재발 방지 대책(lockfile 검증, SBOM 관리)을 포함합니다.
>
> ---
>
...
> **즉시 조치 필요**: 2025년 9월 8일 발생한 npm 역사상 최악의 서플라이체인 공격
