...
{% include news-spotlight-item.html
  title="Tech Monitor - 실시간 AI & Tech 산업 대시보드"
  url="https://tech.worldmonitor.app/"
  source="Tech World Monitor"
  tag="Operator Signal"
  summary="AI와 기술 산업 변화를 한 번에 추적할 수 있는 대시보드형 자료로, 개별 뉴스보다 시장 전체의 방향성과 속도 변화를 읽는 데 적합합니다."
%}
{% include news-spotlight-item.html
  ...
  source="GeekNews"
  tag="Tech Signals"
  summary="Python의 진화 과정을 창시자 시점에서 돌아보는 내용으로, 언어 생태계가 어떻게 장기적인 설계 선택을 통해 안정성을 확보했는지 보여줍니다."
%}
{% include news-spotlight-item.html
  ...
  source="GeekNews"
  tag="Tech Signals"
  summary="개발 속도가 팀의 이해 속도를 초과할 때 생기는 장기적 비용을 짚으며, 생산성보다 인지 부채 관리가 더 중요해질 수 있음을 말합니다."
%}
{% endcapture %}
