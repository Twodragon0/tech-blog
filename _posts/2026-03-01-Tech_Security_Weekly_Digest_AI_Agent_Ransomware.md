...
| 🤖 **AI/ML** | NVIDIA | Agentic AI 기반 통신 자율 네트워크 + AI-RAN 상용화 실증 | 🟡 Medium |
...
- [ ] Gentlemen 랜섬웨어 IoC를 EDR/SIEM 탐지 규칙에 반영
- [ ] SK쉴더스 OT 보안 리포트 검토 후 자사 IT/OT 네트워크 세그멘테이션 점검
- [ ] AI 에이전트 도입 시 권한 관리·감사 로깅 체계 설계 검토
