...
excerpt: "새로운 Windows 'MiniPlasma' 제로데이 익스플로잇 · NGINX CVE-2026-42945 실제 공격 발생이 부각된 2026년 05월 18일 보안 다이제스트 — 15건의 이슈와 실행 가능한 대응 액션을 정리합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
