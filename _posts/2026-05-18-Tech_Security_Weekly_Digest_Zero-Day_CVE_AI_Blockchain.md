...
excerpt: "새로운 Windows 'MiniPlasma' 제로데이 익스플로잇 · NGINX CVE-2026-42945 실제 공격 발생이 부각된 2026년 05월 18일 보안 다이제스트 — 15건의 이슈와 실행 가능한 대응 액션을 정리합니다. 영향받는 자산 식별과 SBOM 기반 의존성 패치, EDR 룰 보강 가이드를 다룹니다."
