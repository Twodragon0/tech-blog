...
excerpt: "2026년 07월 23일 수집한 29건의 보안 이슈 중 Check Point, 전체 관리자 접근을 허용하는 악용된 · Check Point, 공격에 악용된 SmartConsole를 중심으로 영향 범위와 패치 우선순위를 분석합니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
