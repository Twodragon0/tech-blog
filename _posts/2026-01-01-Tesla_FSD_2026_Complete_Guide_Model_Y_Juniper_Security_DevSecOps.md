...
<li><strong>FSD v14.2.1 주요 개선</strong>: 향상된 신경망 비전 인코더, 긴급 차량 자동 인식, 5가지 속도 프로파일, 글로벌 확장</li>
<li><strong>Model Y Juniper</strong>: $49,990부터, HW4, 4680 배터리, 357마일 주행거리</li>
<li><strong>Hardware 4 아키텍처</strong>: 500+ TOPS, 20 CPU 코어, 3 NPU, 11개 5MP 카메라</li>
<li><strong>자동차 보안</strong>: 인포테인먼트 익스플로잇, LTE 취약점, 센서 스푸핑, OTA 공격 벡터</li>
<li><strong>DevSecOps 대응</strong>: OTA 보안, SBOM, Secure Boot, 실시간 모니터링</li>
{% endcapture %}
