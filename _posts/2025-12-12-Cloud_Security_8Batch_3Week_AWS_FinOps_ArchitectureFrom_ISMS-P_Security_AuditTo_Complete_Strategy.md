...
> 
> ```bash
> # Tag Policy 생성 (Organization 수준) [truncated]
> ```
...
> 
> ```bash
> # CloudTrail Insights로 비정상 API 호출 탐지 [truncated]
> ```
