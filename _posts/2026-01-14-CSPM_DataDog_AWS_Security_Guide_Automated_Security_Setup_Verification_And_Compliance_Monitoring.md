...
excerpt: "DataDog CSPM을 활용한 AWS 환경 보안 설정 자동 검증 및 컴플라이언스 모니터링 실무 가이드. Misconfiguration 탐지, 자동화 대응, 실시간 위협 탐지, CIS Benchmark·ISMS-P·PCI-DSS 준수 모니터링까지 DevSecOps 실무 관점 단계별 정리합니다."
...
redirect_from:
  ...
  - /posts/2026-01-14-CSPM_DataDog_AWS_Security_Guide_Automated_Security_Setup_Verification_And_Compliance_Monitoring/
summary_card:
  title: "CSPM(DataDog) AWS 보안 가이드: 자동화된 보안 설정 검증 및 컴플라이언스 모니터링"
  ...
  tags:
    ...
    - "Autonomous Coding"
  highlights:
    - { source: "CSPM 개요", title: "Cloud Security Posture Management 개념, DataDog CSPM 기능 소개, AWS 환경에서의 CSPM 활용" }
    - { source: "DataDog CSPM 설정", title: "DataDog AWS 연동 방법, CSPM 기능 활성화, 리전별 설정" }
    - { source: "보안 설정 검증", title: "보안 그룹 설정 검증, S3 버킷 정책 검증, IAM 정책 검증, Misconfiguration 탐지" }
    - { source: "컴플라이언스 모니터링", title: "CIS AWS Foundations Benchmark 준수 모니터링, ISMS-P 컴플라이언스, PCI-DSS 컴플라이언스" }
    - { source: "자동화된 대응", title: "자동 수정 워크플로우, 알림 설정, 워크플로우 자동화" }
    - { source: "보고서 및 대시보드", title: "보안 상태 대시보드 구성, 컴플라이언스 보고서 생성, 시각화 및 보고" }
    - { source: "Claude Autonomous Coding Agent 통합", title: "CSPM과 Claude Agent를 통한 보안 자동화, 자동 보안 설정 수정, 보안 검증 코드 생성" }
---
...
이 포스팅은 SK Shieldus의 2025년 CSPM(DataDog) AWS 보안 가이드를 기반으로, DataDog CSPM을 활용한 AWS 환경 보안 설정 자동 검증 및 컴플라이언스 모니터링 가이드를 제공합니다.
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| DataDog CSPM 개요 | [docs.datadoghq.com/security/cspm](https://docs.datadoghq.com/security/cspm/) | CSPM 기능 및 설정 가이드 |
| DataDog AWS 통합 | [docs.datadoghq.com/integrations/aws](https://docs.datadoghq.com/integrations/amazon_web_services/) | AWS 통합 설정 방법 |
| DataDog 보안 규칙 | [docs.datadoghq.com/security/rules](https://docs.datadoghq.com/security/default_rules/) | 기본 제공 보안 규칙 |
| DataDog Compliance | [docs.datadoghq.com/security/compliance](https://docs.datadoghq.com/security/compliance/) | 컴플라이언스 프레임워크 |

#### AWS 보안 문서
| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Hub | [docs.aws.amazon.com/securityhub](https://docs.aws.amazon.com/securityhub/) | AWS 보안 통합 서비스 |
| AWS Config | [docs.aws.amazon.com/config](https://docs.aws.amazon.com/config/) | 리소스 설정 모니터링 |
| AWS CloudTrail | [docs.aws.amazon.com/cloudtrail](https://docs.aws.amazon.com/cloudtrail/) | API 호출 로그 |
| AWS Well-Architected | [aws.amazon.com/well-architected](https://aws.amazon.com/architecture/well-architected/) | AWS 아키텍처 모범 사례 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| CIS AWS Foundations | [cisecurity.org/benchmark/aws](https://www.cisecurity.org/benchmark/amazon_web_services) | CIS AWS 보안 벤치마크 |
| CIS Controls v8 | [cisecurity.org/controls/v8](https://www.cisecurity.org/controls/v8) | CIS 보안 통제 프레임워크 |

#### 한국 규제 및 인증
| 리소스 | URL | 설명 |
|--------|-----|------|
| ISMS-P 인증 | [isms.kisa.or.kr](https://isms.kisa.or.kr/) | 정보보호 및 개인정보보호 관리체계 |
| CSAP 인증 | [csap.kisa.or.kr](https://csap.kisa.or.kr/) | 클라우드 보안 인증 |
| 개인정보보호법 | [law.go.kr](https://www.law.go.kr/) | 개인정보보호 법령 |
| 금융보안원 | [fsec.or.kr](https://www.fsec.or.kr/) | 금융권 보안 가이드 |

#### 글로벌 컴플라이언스
| 리소스 | URL | 설명 |
|--------|-----|------|
| PCI-DSS | [pcisecuritystandards.org](https://www.pcisecuritystandards.org/) | 결제 카드 산업 데이터 보안 표준 |
| ISO 27001 | [iso.org/isoiec-27001](https://www.iso.org/isoiec-27001-information-security.html) | 정보 보안 관리 시스템 |
| SOC 2 | [aicpa.org/soc](https://www.aicpa.org/soc) | 서비스 조직 제어 보고서 |
| NIST CSF 2.0 | [nist.gov/cyberframework](https://www.nist.gov/cyberframework) | 사이버보안 프레임워크 |

### 12.3 MITRE ATT&CK 리소스

| 리소스 | URL | 설명 |
|--------|-----|------|
| MITRE ATT&CK Cloud | [attack.mitre.org/cloud](https://attack.mitre.org/matrices/enterprise/cloud/) | 클라우드 공격 기법 매트릭스 |
| T1078 - Valid Accounts | [attack.mitre.org/T1078](https://attack.mitre.org/techniques/T1078/) | 정상 계정 탈취 기법 |
| T1530 - Data from Cloud | [attack.mitre.org/T1530](https://attack.mitre.org/techniques/T1530/) | 클라우드 스토리지 데이터 탈취 |
| T1537 - Transfer Data | [attack.mitre.org/T1537](https://attack.mitre.org/techniques/T1537/) | 클라우드 계정 간 데이터 전송 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| Splunk Cloud | [splunk.com/splunk-cloud](https://www.splunk.com/en_us/products/splunk-cloud-platform.html) | Splunk SIEM 플랫폼 |
| Microsoft Sentinel | [azure.microsoft.com/sentinel](https://azure.microsoft.com/en-us/products/microsoft-sentinel/) | Microsoft 클라우드 네이티브 SIEM |
| DataDog Log Management | [docs.datadoghq.com/logs](https://docs.datadoghq.com/logs/) | DataDog 로그 관리 |

#### 자동화 도구
| 리소스 | URL | 설명 |
|--------|-----|------|
| Terraform AWS Provider | [registry.terraform.io/aws](https://registry.terraform.io/providers/hashicorp/aws/) | Terraform AWS 리소스 프로바이더 |
| AWS CloudFormation | [aws.amazon.com/cloudformation](https://aws.amazon.com/cloudformation/) | AWS 인프라 자동화 |
| Claude Autonomous Coding | [github.com/anthropics](https://github.com/anthropics/claude-quickstarts) | Claude 자동 코딩 에이전트 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Blog | [aws.amazon.com/blogs/security](https://aws.amazon.com/blogs/security/) | AWS 공식 보안 블로그 |
| DataDog Security Blog | [datadoghq.com/blog/security](https://www.datadoghq.com/blog/category/security/) | DataDog 보안 블로그 |
| Cloud Security Alliance | [cloudsecurityalliance.org](https://cloudsecurityalliance.org/) | 클라우드 보안 협회 |

#### 교육 및 트레이닝
| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Training | [aws.amazon.com/training/security](https://aws.amazon.com/training/learn-about/security/) | AWS 보안 교육 |
| DataDog Learning Center | [learn.datadoghq.com](https://learn.datadoghq.com/) | DataDog 학습 센터 |
| SANS Cloud Security | [sans.org/cloud-security](https://www.sans.org/cloud-security/) | SANS 클라우드 보안 교육 |

### 12.6 레퍼런스 아키텍처

| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Reference | [docs.aws.amazon.com/security-reference](https://docs.aws.amazon.com/prescriptive-guidance/latest/security-reference-architecture/) | AWS 보안 참조 아키텍처 |
| DataDog Reference | [datadoghq.com/architecture](https://www.datadoghq.com/architecture/) | DataDog 아키텍처 가이드 |

### 12.7 한국어 자료

| 리소스 | URL | 설명 |
|--------|-----|------|
| SK Shieldus CSPM 가이드 | [skshieldus.com/download](https://www.skshieldus.com/download/files/download.do?o_fname=%2725%EB%85%84%20CSPM(DataDog)%20AWS_%EB%B3%B4%EC%95%88%20%EA%B0%80%EC%9D%B4%EB%93%9C.pdf&r_fname=20251230162028217.pdf) | 2025년 CSPM AWS 보안 가이드 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| Prowler | [github.com/prowler-cloud](https://github.com/prowler-cloud/prowler) | 오픈소스 AWS 보안 도구 |
