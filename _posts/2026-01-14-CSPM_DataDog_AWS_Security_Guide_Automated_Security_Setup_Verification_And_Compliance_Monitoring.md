...
| **Claude Autonomous Coding** | [https://github.com/anthropics/claude-quickstarts) | Claude 자동 코딩 에이전트 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| **Prowler** | [https://github.com/prowler-cloud/prowler) | 오픈소스 AWS 보안 도구 |
...
### 시각 자료
![Post Visual](/assets/images/2026-01-14-CSPM_DataDog_AWS_Security_Guide_Automated_Security_Configuration_Verification_and_Compliance_Monitoring.svg)
