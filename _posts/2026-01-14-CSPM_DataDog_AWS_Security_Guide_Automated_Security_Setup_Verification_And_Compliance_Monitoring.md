...
| 리소스 | URL | 설명 |
|--------|-----|------|
| DataDog CSPM 개요 | [공식 문서](https://docs.datadoghq.com/security/cspm/) | CSPM 기능 및 설정 가이드 |
| DataDog AWS 통합 | [공식 문서](https://docs.datadoghq.com/integrations/amazon_web_services/) | AWS 통합 설정 방법 |
| DataDog 보안 규칙 | [공식 문서](https://docs.datadoghq.com/security/default_rules/) | 기본 제공 보안 규칙 |
| DataDog Compliance | [공식 문서](https://docs.datadoghq.com/security/compliance/) | 컴플라이언스 프레임워크 |

#### AWS 보안 문서
| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Hub | [AWS 문서](https://docs.aws.amazon.com/securityhub/) | AWS 보안 통합 서비스 |
| AWS Config | [AWS 문서](https://docs.aws.amazon.com/config/) | 리소스 설정 모니터링 |
| AWS CloudTrail | [AWS 문서](https://docs.aws.amazon.com/cloudtrail/) | API 호출 로그 |
| AWS Well-Architected | [AWS 문서](https://aws.amazon.com/architecture/well-architected/) | AWS 아키텍처 모범 사례 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| CIS AWS Foundations | [공식 사이트](https://www.cisecurity.org/benchmark/amazon_web_services) | CIS AWS 보안 벤치마크 |
| CIS Controls v8 | [공식 사이트](https://www.cisecurity.org/controls/v8) | CIS 보안 통제 프레임워크 |

#### 한국 규제 및 인증
| 리소스 | URL | 설명 |
|--------|-----|------|
| ISMS-P 인증 | [공식 사이트](https://isms.kisa.or.kr/) | 정보보호 및 개인정보보호 관리체계 |
| CSAP 인증 | [공식 사이트](https://csap.kisa.or.kr/) | 클라우드 보안 인증 |
| 개인정보보호법 | [공식 사이트](https://www.law.go.kr/) | 개인정보보호 법령 |
| 금융보안원 | [공식 사이트](https://www.fsec.or.kr/) | 금융권 보안 가이드 |

#### 글로벌 컴플라이언스
| 리소스 | URL | 설명 |
|--------|-----|------|
| PCI-DSS | [공식 사이트](https://www.pcisecuritystandards.org/) | 결제 카드 산업 데이터 보안 표준 |
| ISO 27001 | [공식 사이트](https://www.iso.org/isoiec-27001-information-security.html) | 정보 보안 관리 시스템 |
| SOC 2 | [공식 사이트](https://www.aicpa.org/soc) | 서비스 조직 제어 보고서 |
| NIST CSF 2.0 | [공식 사이트](https://www.nist.gov/cyberframework) | 사이버보안 프레임워크 |

### 12.3 MITRE ATT&CK 리소스

| 리소스 | URL | 설명 |
|--------|-----|------|
| MITRE ATT&CK Cloud | [공식 사이트](https://attack.mitre.org/matrices/enterprise/cloud/) | 클라우드 공격 기법 매트릭스 |
| T1078 - Valid Accounts | [공식 사이트](https://attack.mitre.org/techniques/T1078/) | 정상 계정 탈취 기법 |
| T1530 - Data from Cloud | [공식 사이트](https://attack.mitre.org/techniques/T1530/) | 클라우드 스토리지 데이터 탈취 |
| T1537 - Transfer Data | [공식 사이트](https://attack.mitre.org/techniques/T1537/) | 클라우드 계정 간 데이터 전송 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| Splunk Cloud | [공식 사이트](https://www.splunk.com/en_us/products/splunk-cloud-platform.html) | Splunk SIEM 플랫폼 |
| Azure Sentinel | [공식 사이트](https://azure.microsoft.com/en-us/products/microsoft-sentinel/) | Microsoft 클라우드 네이티브 SIEM |
| DataDog Log Management | [공식 문서](https://docs.datadoghq.com/logs/) | DataDog 로그 관리 |

#### 자동화 도구
| 리소스 | URL | 설명 |
|--------|-----|------|
| Terraform AWS Provider | [공식 레지스트리](https://registry.terraform.io/providers/hashicorp/aws/) | Terraform AWS 리소스 프로바이더 |
| AWS CloudFormation | [AWS 문서](https://aws.amazon.com/cloudformation/) | AWS 인프라 자동화 |
| Claude Autonomous Coding | [GitHub](https://github.com/anthropics/claude-quickstarts) | Claude 자동 코딩 에이전트 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Blog | [블로그](https://aws.amazon.com/blogs/security/) | AWS 공식 보안 블로그 |
| DataDog Security Blog | [블로그](https://www.datadoghq.com/blog/category/security/) | DataDog 보안 블로그 |
| Cloud Security Alliance | [공식 사이트](https://cloudsecurityalliance.org/) | 클라우드 보안 협회 |

#### 교육 및 트레이닝
| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Training | [학습 센터](https://aws.amazon.com/training/learn-about/security/) | AWS 보안 교육 |
| DataDog Learning Center | [학습 센터](https://learn.datadoghq.com/) | DataDog 학습 센터 |
| SANS Cloud Security | [학습 센터](https://www.sans.org/cloud-security/) | SANS 클라우드 보안 교육 |

### 12.6 레퍼런스 아키텍처

| 리소스 | URL | 설명 |
|--------|-----|------|
| AWS Security Reference | [AWS 문서](https://docs.aws.amazon.com/prescriptive-guidance/latest/security-reference-architecture/) | AWS 보안 참조 아키텍처 |
| DataDog Reference | [공식 문서](https://www.datadoghq.com/architecture/) | DataDog 아키텍처 가이드 |

### 12.7 한국어 자료

| 리소스 | URL | 설명 |
|--------|-----|------|
| SK Shieldus CSPM 가이드 | [SK Shieldus](https://www.skshieldus.com/download/files/download.do?o_fname=%2725%EB%85%84%20CSPM(DataDog)%20AWS_%EB%B3%B4%EC%95%88%20%EA%B0%80%EC%9D%B4%EB%93%9C.pdf&r_fname=20251230162028217.pdf) | 2025년 CSPM AWS 보안 가이드 |
...
| 리소스 | URL | 설명 |
|--------|-----|------|
| Prowler | [GitHub](https://github.com/prowler-cloud/prowler) | 오픈소스 AWS 보안 도구 |
| ScoutSuite | [GitHub](https://github.com/nccgroup/ScoutSuite) | 멀티 클라우드 보안 감사 |
| CloudSploit | [GitHub](https://github.com/aquasecurity/cloudsploit) | 클라우드 보안 스캐너 |
