...
> 
> ```yaml
> # DataDog CSPM 규칙: 개인정보 보호 [truncated]
> ```
...
> 
> ```yaml
> # 보안 그룹 Misconfiguration 탐지 규칙 [truncated]
> ```
...
> 
> ```python
> # Claude Autonomous Coding Agent와 CSPM 통합 예시 [truncated]
> ```
