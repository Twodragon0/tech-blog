...
excerpt: "2026년 04월 13일 수집한 15건의 보안 이슈 중 CPUID 침해로 인해 변조된 CPU-Z 및 HWMonitor · Marimo의 치명적인 사전 인증 RCE 취약점을 중심으로 영향 범위와 패치 우선순위를 분석합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
