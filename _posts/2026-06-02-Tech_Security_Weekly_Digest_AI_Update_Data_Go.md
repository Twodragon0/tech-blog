...
excerpt: "Miasma 공급망 공격, 자격증명 탈취 웜으로 Red Hat · ⚡ 주간 요약: 새로운 Linux 취약점, PAN-OS 익스플로잇이 부각된 2026년 06월 02일 보안 다이제스트 — 30건의 이슈와 실행 가능한 대응 액션을 정리합니다. 각 항목의 원문 링크를 함께 실어 1차 출처에서 바로 확인할 수 있습니다."
