...
excerpt: "GlassWorm 캠페인, Zig 드로퍼로 다중 개발자 IDE 감염 · 브라우저 확장 프로그램은 아무도 논의하지 않는 새로운 AI 소비 등 2026년 04월 11일 보고된 26건의 보안/기술 이슈를 운영 관점에서 점검합니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
