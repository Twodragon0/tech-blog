...
excerpt: "GitHub, PyPI가 공급망 공격 대응을 위한 시간 기반 방어 · Hugging Face CEO, '전례 없는' OpenAI 해킹 등 2026년 07월 27일 보고된 16건의 보안/기술 이슈를 운영 관점에서 점검합니다. 영향받는 자산 식별과 SBOM 기반 의존성 패치, EDR 룰 보강 가이드를 다룹니다."
...
**주요 위협 요소:**
- **크로스체인 브릿지 취약점**: Ethereum, 베이스, 아비트럼, BNB 스마트 체인 등 4개 체인에서 동시에 발생한 점으로 보아, HTLC 계약의 로직 결함이 공격자에게 악용되었을 가능성이 높음
...
| TechCrunch Security | [techcrunch.com](https://techcrunch.com) | 본문 1건 인용 |
