...
excerpt: "2026년 03월 19일 수집한 15건의 보안 이슈 중 OFAC, 가상 원격 일자리로 대량살상무기 프로그램 자금 조달하는 · Interlock 랜섬웨어, Cisco FMC 제로데이를 중심으로 영향 범위와 패치 우선순위를 분석합니다. 실무 체크리스트에 패치 적용 항목을 함께 정리했습니다."
