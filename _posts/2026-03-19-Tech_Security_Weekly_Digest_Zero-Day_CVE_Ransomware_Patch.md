...
| 🤖 **AI/ML** | Meta Engineering Blo | Friend Bubbles: Facebook Reels의 소셜 발견 기능 강화 | 🟡 Medium |
...
> 🔴 **심각도**: Critical | **CVE**: CVE-2026-20131

# Interlock 랜섬웨어의 Cisco FMC Zero-Day(CVE-2026-20131) 악용 분석
...
> 🔴 **심각도**: Critical | **CVE**: CVE-2026-32746

# CVE-2026-32746: GNU InetUtils telnetd 원격 코드 실행 취약점 분석
