...
| 제목 | URL | 설명 |
|------|-----|------|
| AWS WAF 개발자 가이드 | [AWS 문서](https://docs.aws.amazon.com/waf/latest/developerguide/) | AWS WAF 공식 개발자 가이드 |
| CloudFront 개발자 가이드 | [AWS 문서](https://docs.aws.amazon.com/cloudfront/latest/dev/) | CloudFront 공식 개발자 가이드 |
| Origin Access Control (OAC) | [AWS 문서](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.html) | OAC를 사용한 S3 접근 제한 |
| AWS WAF Workshop | [링크](https://sessin.github.io/awswafhol/) | AWS WAF 실습 워크샵 |
| AWS Shield | [AWS 문서](https://docs.aws.amazon.com/shield/latest/developerguide/) | DDoS 방어 서비스 |
| S3 버킷 정책 | [AWS 문서](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucket-policies.html) | S3 버킷 정책 설정 가이드 |
...
| 제목 | URL | 설명 |
|------|-----|------|
| MITRE ATT&CK Framework | [MITRE ATT&CK](https://attack.mitre.org/) | 사이버 공격 기법 및 전술 프레임워크 |
| OWASP Top 10 | [OWASP](https://owasp.org/www-project-top-ten/) | 웹 애플리케이션 보안 위협 Top 10 |
| OWASP Input Validation Cheat Sheet | [OWASP](https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html) | 입력값 검증 가이드 |
| OWASP SSRF Prevention | [OWASP](https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html) | SSRF 방어 가이드 |
| OWASP File Upload Cheat Sheet | [OWASP](https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html) | 파일 업로드 보안 가이드 |
| OWASP Logging Cheat Sheet | [OWASP](https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html) | 로깅 보안 가이드 |
| CWE (Common Weakness Enumeration) | [링크](https://cwe.mitre.org/) | 소프트웨어 취약점 분류 |
...
| 제목 | URL | 설명 |
|------|-----|------|
| Python urllib.parse | [링크](https://docs.python.org/3/library/urllib.parse.html) | URL 파싱 라이브러리 |
| Python requests 문서 | [링크](https://requests.readthedocs.io/) | HTTP 라이브러리 |
...
| 제목 | URL | 설명 |
|------|-----|------|
| KISA 보호나라 | [링크](https://www.boho.or.kr/) | 한국인터넷진흥원 보안 가이드 |
| 금융보안원 (FSI) | [금융보안원](https://www.fsec.or.kr/) | 금융권 보안 가이드 |
| ISMS-P 인증 기준 | [KISA](https://isms.kisa.or.kr/) | 정보보호 관리체계 |
| 개인정보보호법 | [링크](https://www.privacy.go.kr/) | 개인정보보호위원회 |
| 국가사이버안전센터 (NCSC) | [링크](https://www.ncsc.go.kr/) | 국가 차원 위협 정보 |

### 추가 학습 자료

| 제목 | URL | 설명 |
|------|-----|------|
| AWS 보안 모범 사례 | [AWS 문서](https://docs.aws.amazon.com/security/) | AWS 보안 베스트 프랙티스 |
| DevSecOps Manifesto | [링크](https://www.devsecops.org/) | DevSecOps 원칙 |
| NIST Cybersecurity Framework | [NIST](https://www.nist.gov/cyberframework) | 사이버보안 프레임워크 |
...
| 제목 | URL | 설명 |
|------|-----|------|
| 초보를 위한 도커 안내서 | [링크](https://subicura.com/2017/01/19/docker-guide-for-beginners-2.html) | Docker 기초 가이드 |
| 쿠버네티스 시작하기 | [링크](https://subicura.com/2019/05/19/kubernetes-basic-1.html) | Kubernetes 입문 |
