...
> **코드 예시**: 전체 워크플로우는 [GitHub CodeQL 문서](https://docs.github.com/en/code-security/code-scanning/using-codeql-code-scanning-with-your-ci) 및 [CodeQL Action](https://github.com/github/codeql-action)을 참조하세요.
...
> **코드 예시**: 쿼리 설정 예시는 [CodeQL 쿼리 작성 가이드](https://docs.github.com/en/code-security/codeql-cli/using-the-codeql-cli/creating-codeql-query-suites)와 [CodeQL 예제 저장소](https://github.com/github/codeql)를 참고하세요.
