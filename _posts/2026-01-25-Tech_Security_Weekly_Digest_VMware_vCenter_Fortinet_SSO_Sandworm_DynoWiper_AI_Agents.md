...
excerpt: "2026년 1월 25일 주요 기술/보안 뉴스 심층 분석: CISA KEV에 추가된 VMware vCenter 취약점(CVE-2024-37079), Fortinet FortiGate SSO 우회 공격, Sandworm의 DynoWiper를 이용한 폴란드 전력망 공격, AI 에이전트 보안 거버넌스, Google ADK와 Datadog 통합까지 DevSecOps 실무 관점에서 분석합니다."
comments: true
