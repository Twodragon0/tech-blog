...
excerpt: "Ask Gordon AI 비서의 이미지 메타데이터 기반 코드 실행 · React Native CLI Metro4Shell RCE - 등 2026년 02월 04일 보고된 15건의 보안/기술 이슈를 운영 관점에서 점검합니다. 실무 체크리스트에 패치 적용 항목을 함께 정리했습니다."
...
| 섹션 | 주제 | 우선순위 |
|------|------|---------|
| [1. CVE-2025-11953 Metro4Shell](#1-cve-2025-11953-metro4shell-react-native-cli-rce-심층-분석) | React Native CLI RCE (CVSS 9.8) | P0 즉시 |
| [2. AWS IAM Identity Center 멀티리전](#2-aws-iam-identity-center-멀티리전-보안-영향-분석) | 멀티리전 보안 아키텍처 | P1 7일 |
| [3. AI 에이전트 3Cs 프레임워크](#3-ai-에이전트-보안-3cs-프레임워크-심층-분석) | Docker 보안 프레임워크 발표 | P1 7일 |
| [4. 트렌드 분석](#4-트렌드-분석) | 주간 보안 트렌드 요약 | 참고 |
| [5. 실무 체크리스트](#실무-체크리스트) | 즉시/단기/중기 대응 항목 | 전체 |
...
> 참고: CI/CD 파이프라인 보안 강화 관련 내용은 [GitHub Actions 보안 가이드](https://docs.github.com/en/actions) 및 [SonarQube](https://github.com/SonarSource/sonarqube)를 참조하세요.
