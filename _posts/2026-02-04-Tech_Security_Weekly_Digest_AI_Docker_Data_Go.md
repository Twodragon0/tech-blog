...
> **제목**: 2026년 2월 4일 주간 기술 보안 다이제스트: Docker AI 취약점, CVE-2025-11953, RCE 공격

> **카테고리**: security, devsecops

> **태그**: Security-Weekly, DevSecOps, Cloud-Security, Docker, CVE-2025-11953, Metro4Shell, RCE, AI-Agent-Security, AWS-IAM, "2026"

> **핵심 내용**: 
> - Docker Ask Gordon AI 코드 실행 취약점(DockerDash), Metro4Shell RCE(CVE-2025-11953, CVSS 9.8), AWS IAM Identity Center 멀티리전, AI 에이전트 3Cs 보안 프레임워크 심층 분석

> **주요 기술/도구**: Security, DevSecOps, Security, Docker, Security, AWS, security, devsecops
