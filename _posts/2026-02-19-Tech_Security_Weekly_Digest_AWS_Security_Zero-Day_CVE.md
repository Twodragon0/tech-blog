...
excerpt: "Dell RecoverPoint VM CVE-2026-22769 · 실무 관점에서 영향 범위와 우선순위를 함께 점검해야 합니다가 부각된 2026년 02월 19일 보안 다이제스트 — 27건의 이슈와 실행 가능한 대응 액션을 정리합니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
