...
excerpt: "2026년 05월 02일 수집한 19건의 보안 이슈 중 3만 개의 Facebook 계정, Google AppSheet 피싱 · AI 시대의 보안 태세 개선을 중심으로 영향 범위와 패치 우선순위를 분석합니다. 본문 말미의 실무 체크리스트에 팀에서 바로 나눠 가질 점검 항목을 정리했습니다."
