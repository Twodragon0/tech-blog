...
excerpt: "2026년 07월 02일 수집한 30건의 보안 이슈 중 패치되지 않은 Argo CD Repo-Server 취약점으로 · 19세 Scattered Spider 용의자를 중심으로 영향 범위와 패치 우선순위를 분석합니다. 각 항목의 원문 링크를 함께 실어 1차 출처에서 바로 확인할 수 있습니다."
