...
excerpt: "2026년 07월 08일 수집한 30건의 보안 이슈 중 RedWing MaaS가 Android 은행 사기를 Telegram · Rogue Agent 결함으로 공격자가 Google를 중심으로 영향 범위와 패치 우선순위를 분석합니다. 실무 체크리스트에 패치 적용 항목을 함께 정리했습니다."
