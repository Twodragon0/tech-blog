...
redirect_from:
  ...
  - /posts/2026-03-07-LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP/
summary_card:
...
- LLM 서비스는 프롬프트 인젝션, RAG 오염, MCP 권한 남용이 결합된 복합 위협에 노출되어 보안 설계가 필수 운영 과제로 전환되었습니다.
- 단기적으로는 데이터 경계 분리, 도구 호출 권한 최소화, 모델·가중치 무결성 검증 체계를 우선 구축해야 합니다.

## 위험 스코어카드

| 영역 | 현재 위험도 | 즉시 조치 |
|------|-------------|-----------|
| 프롬프트 인젝션 | High | 입력 검증·시스템 프롬프트 보호·출력 필터링 강화 |
| RAG 파이프라인 | High | 문서 신뢰도 검증, 검색 결과 격리 및 재검증 |
| MCP/도구 권한 | High | 서버 인증, 최소 권한 토큰, 호출 감사 로그 적용 |

## 실행 체크리스트

- 프롬프트 인젝션 테스트 케이스를 CI 보안 검증에 추가
- RAG 데이터 소스 무결성 검증 및 오염 탐지 룰 적용
- MCP 서버별 권한 범위와 호출 제한 정책 문서화
- 모델 아티팩트 서명 검증 및 배포 파이프라인 점검
- LLM 사고 대응 시나리오(데이터 유출/권한 남용) 훈련
...
첫째, 프롬프트 인젝션의 직접/간접 공격 원리와 2026년 기준 방어 전략.
둘째, RAG 파이프라인을 표적으로 한 문서 오염, 검색 결과 조작, 메타데이터 인젝션 공격과 방어 설계.
셋째, MCP 프로토콜이 확산되면서 등장한 새로운 위협 모델과 실무 대응법.
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-1.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-2.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-3.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-4.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-5.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-6.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-7.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-8.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-9.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-10.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-11.svg)
...
![Mermaid Diagram](/assets/images/mermaid/LLM_Security_Practical_Guide_Prompt_Injection_RAG_MCP-mermaid-12.svg)
