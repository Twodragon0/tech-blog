...
excerpt: "2026년 01월 26일 수집한 15건의 보안 이슈 중 HashiCorp의 비인간 ID(NHI) 대규모 관리 전략 - · Gemini Nano 온디바이스 LLM으로 기술지원 사기 실시간 차단을 중심으로 영향 범위와 패치 우선순위를 분석합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
