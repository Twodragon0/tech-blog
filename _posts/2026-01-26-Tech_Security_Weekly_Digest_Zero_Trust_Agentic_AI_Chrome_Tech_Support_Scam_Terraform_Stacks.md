...
| 도구 | 용도 | GitHub/공식 사이트 |
|------|------|-------------------|
| SPIFFE/SPIRE | 워크로드 신원 관리 | [https://github.com/spiffe/spire) |
| Trivy | 컨테이너/IaC 취약점 스캔 | [https://github.com/aquasecurity/trivy) |
| tfsec | Terraform 보안 정적 분석 | [https://github.com/aquasecurity/tfsec) |
| PromptGuard | Prompt Injection 탐지 라이브러리 | [https://github.com/protectai/promptguard) |
...
| Cloud Native Korea | CNCF 한국 커뮤니티 | [https://github.com/cloud-native-korea) |
