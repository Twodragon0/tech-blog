...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    Vault-Based NHI Management Architecture                   │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────────┐                      ┌─────────────────┐              │
│  │   AI Agent      │                      │  HashiCorp      │              │
...
│  └────────┬────────┘    Dynamic Token     └────────┬────────┘              │
│           │                                        │                        │
│           │ 1. Auto Auth                           │ 2. Token Issue         │
│           │    (K8s Service Account)               │    (5분 TTL)           │
│           ▼                                        ▼                        │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │                        Vault Agent Sidecar                           │   │
│  ├─────────────────────────────────────────────────────────────────────┤   │
...
│  │  • HUP Signal on Rotation                                            │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│           │                                                                 │
│           │ 3. Secrets Injection                                            │
│           ▼                                                                 │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │  /etc/secrets/ai-agent.json                                          │   │
│  │  ├── api_keys (auto-rotated)                                         │   │
...
│                                                                 │
│  즉시 (1-2일)                                                   │
│  ├─ Chrome Enterprise 최신 버전 배포 확인                       │
│  └─ 조직 내 AI 에이전트 인벤토리 시작                           │
│                                                                 │
│  단기 (1-2주)                                                   │
│  ├─ NHI 관리 전략 수립 검토                                     │
│  ├─ LLM 애플리케이션 Prompt Injection 취약점 점검               │
│  └─ Terraform Stacks 마이그레이션 가능성 평가                   │
│                                                                 │
│  중기 (1-3개월)                                                 │
│  ├─ Vault 기반 동적 자격증명 파일럿                             │
│  ├─ 보안 도구 통합 로드맵 수립                                  │
│  └─ 2026 클라우드 전략 조직 점검                                │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
