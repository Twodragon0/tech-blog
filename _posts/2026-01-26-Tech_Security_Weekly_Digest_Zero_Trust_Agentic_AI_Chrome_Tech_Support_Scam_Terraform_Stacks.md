...
<!-- SIEM_DETECTION_QUERIES
Splunk SPL을 활용해 프록시 로그에서 기술 지원 사기(Tech Support Scam)를 탐지하는 방법입니다.
...
Azure Sentinel KQL을 활용한 Chrome Safe Browsing 보안 알림 관련 정보입니다.
CommonSecurityLog
...
<!-- SIEM_DETECTION_QUERIES
Splunk SPL을 통해 권한 없는 Terraform Destroy 실행을 탐지하며, index=terraform_logs 및 sourcetype=terraform:audit을 검색 조건으로 활용합니다.
...
Azure Sentinel KQL을 활용하여 Terraform State 파일에 대한 의심스러운 접근 시도를 탐지하고 보안 모니터링을 강화할 수 있습니다.
AzureActivity
