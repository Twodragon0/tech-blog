...
{%- include ai-summary-card.html
  ...
  tags_html='<span class="tag">AI-Security</span>
  ...
  highlights_html='<li><strong>AISLE AI OpenSSL 제로데이 12건 전량 발견</strong>: 역사상 최초로 AI 시스템이 인터넷 암호화 핵심 라이브러리의 모든 신규 취약점 발견</li>
