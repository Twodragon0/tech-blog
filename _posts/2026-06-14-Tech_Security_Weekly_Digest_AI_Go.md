...
| [거절된 이모지 제안들](https://news.hada.io/topic?id=30468) | GeekNews (긱뉴스) | 공식 문자 제안서에 오른 뒤 새 문자 추가로 이어지지 않은 이모지 후보 를 범주별 표로 모은 목록임 대상은 Unicode Consortium에 제출된 공식 문자 제안서 의 이모지이며, 개요 문서의 논의나 비공식 요청은 집계하지 않음 공식 불승인 공지가 없어도 |
...
| Cointelegraph | [cointelegraph.com](https://cointelegraph.com) | 본문 5건 인용 |
| CoinDesk | [coindesk.com](https://www.coindesk.com) | 본문 1건 인용 |
