...
excerpt: "Microsoft, 활성 공격 중인 제로데이 2건 포함 역대 최다 · 놓치셨다면: 2026년 6월 AWS Security 소식이 부각된 2026년 07월 15일 보안 다이제스트 — 29건의 이슈와 실행 가능한 대응 액션을 정리합니다. 사안별 소스와 영향도를 표로 정리해 우선순위 판단 근거를 남겼습니다."
