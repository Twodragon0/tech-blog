...
> **Note:** `daily-news.yml` was removed 2026-07-08. Scheduled publishing
> runs through `ai-blogwatcher.yml`. New automation steps should target that
> workflow.

Add to `.github/workflows/ai-blogwatcher.yml`:
