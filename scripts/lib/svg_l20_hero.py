...
def vb_cve_chain(cx: int, cy: int, theme: str = "red") -> str:
    ...
    return (
        ...
        f'<g transform="translate(-148,-100)">'
...
def vb_hub_spoke(cx: int, cy: int, theme: str = "blue", center_label: str = "C2") -> str:
    ...
    return (
        ...
        f'<g transform="translate(-18,-8)" stroke="{soft}" stroke-width="0.9" fill="none"><rect x="0" y="0" width="9" height="5" rx="1"/><circle cx="2" cy="2.5" r="0.6" fill="{a}"/><circle cx="5" cy="2.5" r="0.6" fill="{a}"/></g>'
        f'<text x="3" y="2" text-anchor="middle" fill="{soft}">EDGE-1</text>'
        ...
        # EDGE-2 (router icon)
        f'<g transform="translate(112,0)"><rect x="-24" y="-12" width="48" height="24" rx="4" fill="#0A2040" stroke="{a}" stroke-width="1.2"/>'
        f'<g transform="translate(-18,-8)" stroke="{soft}" stroke-width="0.9" fill="none"><rect x="0" y="0" width="9" height="5" rx="1"/><circle cx="2" cy="2.5" r="0.6" fill="{a}"/><circle cx="5" cy="2.5" r="0.6" fill="{a}"/></g>'
        f'<text x="3" y="2" text-anchor="middle" fill="{soft}">EDGE-2</text>'
        ...
        # RELAY (antenna icon)
        f'<g transform="translate(92,58)"><rect x="-24" y="-12" width="48" height="24" rx="4" fill="#0A2040" stroke="#FFB703" stroke-width="1.2"/>'
        f'<g transform="translate(-18,-4)" stroke="#FFD58A" stroke-width="0.9" fill="none"><path d="M2 4 L0 0 M2 4 L4 0 M2 4 L2 8"/></g>'
        f'<text x="4" y="2" text-anchor="middle" fill="#FFD58A">RELAY</text></g>'
        # PROXY (forward arrows)
        f'<g transform="translate(-92,58)"><rect x="-24" y="-12" width="48" height="24" rx="4" fill="#0A2040" stroke="#FFB703" stroke-width="1.2"/>'
        f'<g transform="translate(-19,-3)" stroke="#FFD58A" stroke-width="0.9" fill="none"><path d="M0 3 L4 0 L4 6 Z" fill="#FFD58A"/></g>'
        f'<text x="4" y="2" text-anchor="middle" fill="#FFD58A">PROXY</text></g>'
        # VICTIM (laptop icon)
        f'<g transform="translate(-112,0)"><rect x="-24" y="-12" width="48" height="24" rx="4" fill="#0A2040" stroke="#4ADE80" stroke-width="1.2"/>'
        f'<g transform="translate(-19,-6)" stroke="#4ADE80" stroke-width="0.9" fill="none"><rect x="0" y="0" width="8" height="5" rx="0.6"/><path d="M-1 7 L9 7"/></g>'
        f'<text x="4" y="2" text-anchor="middle" fill="#4ADE80">VICTIM</text></g>'
        # CREDS (key icon)
...
def vb_container_escape(cx: int, cy: int, theme: str = "red") -> str:
    ...
    return (
        ...
        # Spark particles around the breach point
        f'<g fill="{soft}">'
        f'<circle cx="-32" cy="36" r="1.2"><animate attributeName="opacity" values="0;1;0" dur="1.4s" repeatCount="indefinite"/></circle>'
        f'<circle cx="34" cy="38" r="1.4"><animate attributeName="opacity" values="0;1;0" dur="1.6s" begin="0.2s" repeatCount="indefinite"/></circle>'
