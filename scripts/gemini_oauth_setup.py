...
def main():
    ...
    parser.add_argument('--setup', action='store_true', help='gcloud CLI를 사용하여 자동 설정')
    parser.add_argument('--verify', action='store_true', help='현재 설정 확인')
    parser.add_argument('--instructions', action='store_true', help='수동 설정 가이드 출력')
    ...
    if args.setup:
        ...
        print("  python3 scripts/gemini_oauth_setup.py --instructions # 수동 설정 가이드")
