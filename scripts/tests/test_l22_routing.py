...
@pytest.mark.parametrize(
    "topic,expected_visual,expected_label",
    [
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"CNCF CLOUD", "CHAIN INTEL"},
        ),
    ],
)
def test_l22_digest_render_contains_expected_labels(
    tmp_path, post_name, expected_labels
):
