...
class TestRulePrecedence:
    ...
    def test_agent_fires_before_lock_in_mixed_digest_title(self):
        ...
        """
        result = pick(
            "security", "주간 보안 다이제스트: BYOVD EDR·AI 에이전트·클라우드"
        )
        assert result == "agent"
    ...
    def test_zero_day_in_digest_routes_to_lock_not_shield(self):
        ...
        assert (
            pick("security", "2026년 제로데이·랜섬웨어·패치 다이제스트")
            == "incident_timeline"
        )
...
class TestAiThreatRouting:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "security",
                "Agentic AI Security 2026 Attack Vectors Defense Architecture",
                "ai_threat",
            ),
            ...
            (
                "security",
                "OWASP 2025 Agentic AI Security threat landscape",
                "ai_threat",
            ),
